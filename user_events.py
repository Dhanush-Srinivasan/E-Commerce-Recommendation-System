...
# Filter the DataFrame to include only specified events: view, purchase, and click
filtered_df = df.filter(df.event_type.isin("view", "purchase", "click")) \
                 .select("user_id", "product_id", "product_name", "product_type", "event_type", "timestamp")

# Write the filtered data to a CSV file for Tableau
output_path = "C:/Users/mural/OneDrive/Desktop/SEM5/user_events.csv"
